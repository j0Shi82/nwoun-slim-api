...
abstract class Article implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Schema\\Crawl\\Article\\Map\\ArticleTableMap';
     ...
     * @return $this|\App\Schema\Crawl\Article\Article The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Schema\Crawl\Article\Article
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Schema\Crawl\Article\Article The current object, for fluid interface
     */
