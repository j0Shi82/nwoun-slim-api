...
abstract class AuctionAggregates implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Schema\\Crawl\\AuctionAggregates\\Map\\AuctionAggregatesTableMap';
     ...
     * @return $this|\App\Schema\Crawl\AuctionAggregates\AuctionAggregates The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Schema\Crawl\AuctionAggregates\AuctionAggregates
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Schema\Crawl\AuctionAggregates\AuctionAggregates The current object, for fluid interface
     */
