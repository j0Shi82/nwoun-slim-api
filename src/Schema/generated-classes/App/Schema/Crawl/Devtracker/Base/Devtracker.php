...
abstract class Devtracker implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Schema\\Crawl\\Devtracker\\Map\\DevtrackerTableMap';
     ...
     * @return $this|\App\Schema\Crawl\Devtracker\Devtracker The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Schema\Crawl\Devtracker\Devtracker
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Schema\Crawl\Devtracker\Devtracker The current object, for fluid interface
     */
