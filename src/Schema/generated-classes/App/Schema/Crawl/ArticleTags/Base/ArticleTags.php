...
/**
 * Base class that represents a row from the 'article_tags' table.
 *
 *
 *
...
abstract class ArticleTags implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Schema\\Crawl\\ArticleTags\\Map\\ArticleTagsTableMap';
     ...
     * @return $this|\App\Schema\Crawl\ArticleTags\ArticleTags The current object (for fluent API support)
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO article_tags (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Schema\Crawl\ArticleTags\ArticleTags
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Schema\Crawl\ArticleTags\ArticleTags The current object, for fluid interface
     */
