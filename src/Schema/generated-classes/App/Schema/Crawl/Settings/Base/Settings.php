 ...
 *
 *
 * @package    propel.generator.App.Schema.Crawl.Settings.Base
 */
abstract class Settings implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Schema\\Crawl\\Settings\\Map\\SettingsTableMap';
    ...
    /**
     * Initializes internal state of App\Schema\Crawl\Settings\Base\Settings object.
     */
     ...
     * @return $this|\App\Schema\Crawl\Settings\Settings The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Schema\\Crawl\\Settings\\Settings'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Schema\Crawl\Settings\Settings
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Schema\Crawl\Settings\Settings The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Schema\Crawl\Settings\Settings (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Schema\Crawl\Settings\Settings Clone of current object.
     * @throws PropelException
     */
