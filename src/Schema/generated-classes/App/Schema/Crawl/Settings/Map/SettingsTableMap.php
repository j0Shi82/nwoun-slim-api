...
class SettingsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Schema.Crawl.Settings.Map.SettingsTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Schema\\Crawl\\Settings\\Settings';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Schema.Crawl.Settings.Settings';
