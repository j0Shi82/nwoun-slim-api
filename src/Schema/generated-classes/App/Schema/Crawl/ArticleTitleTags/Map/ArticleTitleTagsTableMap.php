...
class ArticleTitleTagsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Schema.Crawl.ArticleTitleTags.Map.ArticleTitleTagsTableMap';
     ...
     */
    const TABLE_NAME = 'article_title_tags';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Schema\\Crawl\\ArticleTitleTags\\ArticleTitleTags';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Schema.Crawl.ArticleTitleTags.ArticleTitleTags';
     ...
     */
    const COL_ARTICLE_ID = 'article_title_tags.article_id';

    /**
     * the column name for the tag_id field
     */
    const COL_TAG_ID = 'article_title_tags.tag_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ArticleTitleTagsTableMap::COL_ARTICLE_ID, ArticleTitleTagsTableMap::COL_TAG_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ArticleTitleTagsTableMap::COL_ARTICLE_ID => 0, ArticleTitleTagsTableMap::COL_TAG_ID => 1, ),
